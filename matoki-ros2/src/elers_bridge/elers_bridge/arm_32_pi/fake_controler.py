...
ros = roslibpy.Ros(host='192.168.0.100', port=9090)
...
def callback(message):
    ...
    device.emit(uinput.ABS_X, int(axes[0] * 32767))  # X axis
    device.emit(uinput.ABS_Y, int(axes[1] * 32767))  # Y axis
    device.emit(uinput.ABS_Z, int(axes[2] * 32767))  # Z axis
    device.emit(uinput.ABS_RX, int(axes[3] * 32767))  # RX axis
