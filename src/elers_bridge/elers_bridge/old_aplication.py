...
#need to check if this code work

#------------------------------------this eitan part not in use --------------------------------------------------------------
...
####not use rc in suscribe anymore
...
def main():
    ...
    # Stream URLs
    #app_elers_url = 'http:/192.168.0.101:3000'
    capsule_cam = 'rtsp://admin:password1@192.168.1.64:554/Streaming/Channels/101/'
    fpv_cam = 'http://127.0.0.1:5050/?action=stream'
    ## neet do check how to add this url to the main aplication ?? - maby instad the camera ???

    stream_urls = [capsule_cam, fpv_cam]  #i can change thing at the aplication if i open it like thaat ?
